...
public class WorkoutSaverTest {
    public static void main(String[] args) throws Exception {
        ...
        Workout testIntervalWorkout = new Workout(Sport.RUNNING, null, Collections.singletonList(testInterval));
        ...
        Workout testIntervalWorkout2 = new Workout(Sport.RUNNING, null, Arrays.asList(interval2Steps));
